...
if (temperature >= 80 && rain === true) {
  ...
  console.log ('One should wear a dress and there is no need for an umbrella')
} else if (temperature > 60 && temperature < 80 && rain === false){
  console.log ('One should wear pants and a shirt and there is no need for an umbrella')
} else if (temperature <= 60 && rain === false){
  console.log ('One should wear a jacket and jeans and there is no need for an umbrella')
}
